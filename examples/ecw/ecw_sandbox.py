...
jwks = JWKS(client_id=os.getenv("ECW_SANDBOX_CLIENT_ID"), jku=os.getenv("JKU"), key=key_json)
...
# %%
# ExportJob(content_location='https://staging-fhir.ecwcloud.com/fhir/r4/FFBJCD/$export-poll-location?job_id=f5823cae-ac97-40e4-be70-79c0376c10a0', retry_after=120)